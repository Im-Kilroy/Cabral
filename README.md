...
There are several approaches to solving the TSP. For this project, I chose **Simulated Annealing (SA)**, a probabilistic optimization technique inspired by the physical process of annealing in metallurgy. The algorithm explores different possible solutions and can occasionally accept worse solutions in order to escape local optima, gradually becoming more selective as the optimization progresses.
